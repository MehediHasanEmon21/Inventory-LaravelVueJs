    ...
    <div>
       ...
       <div class="row card container">
          <div class="card-header">
            ...
            Employee  
            <router-link to="/add-employee" class="btn btn-sm btn-info" id="add_new"> Add New</router-link>
          </div>
          <div class="card-body">
            <div class="card-body">
                ...
                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr v-for="employee in filterEmployees" :key="employee.id">
                      ...
                      <td>
                    	<router-link :to="{name: 'edit-employee',params: {id: employee.id }}" class="btn btn-info btn-sm">Edit</router-link>
